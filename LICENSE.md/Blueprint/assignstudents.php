...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-sm-10 col-xs-8" id="rslt">
				<center>
				<h1> Assign Student </h1></center>
	
					<input type="checkbox" id="checkAll" style="margin-top:20px;"> Assign All		
					<p align="right" style="margin-top:-20px;">
						<button class="btn btn-success btn-sm btn-block" id="right" >Assign Selected</button>
					</p>
					
				<table class="table table-bordered tablle-responsive">
				    <thead>
				    ...
				    <?php 
					    		...
					    		$sql = mysql_query("SELECT * FROM `studentsinfo` WHERE 'StudStatus' = 0 AND `StudStatus`=0") or die(mysql_error());
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><a href="studassign.php?studID=<?php echo $row['studID']; ?>&StudDep=<?php echo $row['course']; ?>&studName=<?php echo $row['fullname'];?>"> <button class="btn btn-danger">Assign to Lecturer</button></a></td>
