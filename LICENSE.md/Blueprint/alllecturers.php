...
<body>
	...
	<div class="container-fluid">
		...
		<div class="col-sm-10 col-xs-8" id="docu">
				<center>
				<h1> All Lecturers</h1>
				</center><br>
				<div class="table-responsive">
				  ...
				  <table class="table table-bordered">
				    ...
				    <?php 
					    		...
					    		$sql = mysql_query("SELECT * FROM `lecturerinfo`") or die(mysql_error());
				    ...
				    <tbody>
				      <tr>
				        ...
				        <td><?php echo $row['lectInstitution']; ?></td>
				        <td><?php echo $row['lectdepartment']; ?></td>
				        <td><?php echo $row['lectIDno']; ?></td>
				      </tr>
				      <?php 
					  		}
					  ?>
